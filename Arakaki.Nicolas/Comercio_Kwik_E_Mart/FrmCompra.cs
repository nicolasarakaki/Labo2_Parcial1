...
namespace Comercio_Kwik_E_Mart
{
    public partial class FrmCompra : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            if (dgvInventario.RowCount > 0)
            {
                ...
                if (int.TryParse(tbxCantidad.Text, out cantidadPedida)
                    && Validacion.EsNumeroInt(tbxCantidad.Text)
                    && cantidadPedida > 0
        ...
        private void btnConfirmarCompra_Click(object sender, EventArgs e)
        {
            ...
            {
                int dniCliente;
                if (Validacion.EsNumeroInt(tbxDniCliente.Text) && int.TryParse(tbxDniCliente.Text, out dniCliente))
                {
        ...
        private bool ValidarCompra()
        {
            ...
            if (dgvCompra.RowCount > 0
                ...
                && !string.IsNullOrEmpty(tbxDniCliente.Text) && Validacion.EsNumeroInt(tbxDniCliente.Text))
            {
                retorno = true;
            }
            ...
            else if (!Validacion.EsNumeroInt(tbxDniCliente.Text))
            {
